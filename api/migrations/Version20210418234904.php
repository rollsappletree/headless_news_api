 ...
 */
final class Version20210418234904 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, author_id INT NOT NULL, news_id INT NOT NULL, text VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
